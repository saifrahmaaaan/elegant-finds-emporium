      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/designers" className="group text-gray-600 hover:text-gray-900">
                <span className="relative">
                  Designers
                  <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-900 transition-all duration-300 group-hover:w-full"></span>
                </span>
              </Link></li>
              <li><Link to="/new-arrivals" className="group text-gray-600 hover:text-gray-900">
                <span className="relative">
                  New Arrivals
                  <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-900 transition-all duration-300 group-hover:w-full"></span>
                </span>
              </Link></li>
              <li><Link to="/sale" className="group text-gray-600 hover:text-gray-900">
                <span className="relative">
                  Sale
                  <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-900 transition-all duration-300 group-hover:w-full"></span>
                </span>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/returns" className="group text-gray-600 hover:text-gray-900">
                <span className="relative">
                  Returns & Exchanges
                  <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-900 transition-all duration-300 group-hover:w-full"></span>
                </span>
              </Link></li>
              <li><Link to="/shipping" className="group text-gray-600 hover:text-gray-900">
                <span className="relative">
                  Shipping Info
                  <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-900 transition-all duration-300 group-hover:w-full"></span>
                </span>
              </Link></li>
              <li><Link to="/contact" className="group text-gray-600 hover:text-gray-900">
                <span className="relative">
                  Contact Us
                  <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-900 transition-all duration-300 group-hover:w-full"></span>
                </span>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="group text-gray-600 hover:text-pink-600 relative">
                ...
                <span className="absolute bottom-0 left-0 w-0 h-px bg-pink-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="group text-gray-600 hover:text-blue-600 relative">
                <Facebook className="h-5 w-5" />
                <span className="absolute bottom-0 left-0 w-0 h-px bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="group text-gray-600 hover:text-red-600 relative" aria-label="Pinterest">
              ...
              <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="group text-gray-600 hover:text-green-600 relative" aria-label="WhatsApp">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                ...
                <span className="absolute bottom-0 left-0 w-0 h-px bg-green-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link to="/privacy" className="group text-gray-500 hover:text-gray-700 text-sm">
              <span className="relative">
                Privacy Policy
                <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-700 transition-all duration-300 group-hover:w-full"></span>
              </span>
            </Link>
            <Link to="/terms" className="group text-gray-500 hover:text-gray-700 text-sm">
              <span className="relative">
                Terms of Service
                <span className="absolute bottom-0 left-0 w-0 h-px bg-gray-700 transition-all duration-300 group-hover:w-full"></span>
              </span>
